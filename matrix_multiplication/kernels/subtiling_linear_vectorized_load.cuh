...
// DATATYPE:   half
// CONFIG:     datatype=half TILE_LINEAR_LOAD_M=64 TILE_LINEAR_LOAD_N=128 TILE_LINEAR_LOAD_K=16 THREAD_DIM_LINEAR_LOAD=8 PADDING_LINEAR_LOAD=0 THREADS=128
// TFLOPS:     16.70
// Efficiency: 85.69%
// =====================================================================
